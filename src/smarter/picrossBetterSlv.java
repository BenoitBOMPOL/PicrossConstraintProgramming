...
public class picrossBetterSlv extends picross{
    ...
    public picrossBetterSlv(String filename) throws Exception {
        super(filename);
    ...
    public static void main(String[] args) {
        ...
        picrossBetterSlv picross = null;
        try {
            picross = new picrossBetterSlv(filename);
            ...
            System.out.println("[picrossBetterSlv] Instance creation has failed");
            e.printStackTrace();
        }
    }
}
